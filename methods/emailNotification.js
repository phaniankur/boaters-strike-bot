                                                        ...
                                                        <table class="heading_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                            <tr>
                                                                <td class="pad" style="padding-top:15px;text-align:center;width:100%;padding-bottom:5px;">
                                                                    <h3 style="margin: 0; color: #8a3c90; direction: ltr; font-family: 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; font-size: 24px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder" style="color: #f7f6f5;">Know more about us.</span></h3>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td class="pad" style="text-align:center;padding-top:5px;padding-bottom:5px;">
                                                                    <div class="alignment" align="center">
                                                                        ...
                                                                        <a href="https://www.boatrr.in/" style="text-decoration: none; color: #f7f6f5;">Know More</a></strong></span></span></div>
                                                            ...
                                                            <tr>
                                                                <td class="pad">
                                                                    <div class="alignment" align="center">
                                                                        ...
                                                                        <a href="https://api.whatsapp.com/send/?phone=919566015464&text=Claim%20my%20benefits.%20OrderID%3A%20${data.orderDetails.orderID}&type=phone_number&app_absent=0" style="text-decoration: none;color: #f7f6f5;">Claim your free benefits!</a></span></span></div>
                                                                        <!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td class="pad">
                                                                    <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                        <div class style="font-size: 12px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px; color: #f7f6f5; line-height: 1.5;">
                                                                            <p style="margin: 0; text-align: center; mso-line-height-alt: 21px;"><span style="font-size:14px;"><a style="text-decoration: underline; color: #f7f6f5;" rel="noopener">Terms & Conditions</a></span></p>
